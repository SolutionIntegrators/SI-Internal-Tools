...
export function chatSystemPrompt(env, now) {
  return [
    ...
    "Use the search tools to answer with real current information from ClickUp, Google Calendar, Airtable, and her client portal. Do not guess or make things up. If a tool returns nothing, say so plainly rather than filling the gap.",
